...
const Header = () => {
    return (
        <div className='bg-[#202028] h-20 px-4 flex justify-between items-center'>
            <div className='relative'>
                <HiOutlineSearch fontSize={20} className='text-[#76777a] absolute top-1/2 -translate-y-1/2 left-3' />
                <input type='text' placeholder='Search...' className='text-sm bg-[#2a2b30] focus:outline-none active:outline-none h-10 w-[24rem] border border-[#2a2b30] rounded-lg px-4 pl-11 pr-4' />
            </div>
            <div className='flex items-center mr-2 gap-2'>
                <div className='border border-[#43454a] bg-[#43454a] rounded-full p-2'>
